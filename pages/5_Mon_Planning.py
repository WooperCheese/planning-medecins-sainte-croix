"""
Page médecin : consultation du planning de toute l'équipe (lecture seule).

Réutilise exactement le même composant que la vue "par médecin" de la page
admin (app/ui/planning_grid.construire_grille_par_medecin /
styliser_grille_par_medecin) : aucune duplication de logique d'affichage.
Aucune génération, aucune édition possible ici.
...
st.caption("Lecture seule. Pour toute correction, contacte l'admin.")
